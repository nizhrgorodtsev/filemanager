...
<div class="itemBody">
	...
	<div class="itemHeader">
		...
		<?php if($this->item->params->get('itemDateCreated')): ?>
			...
			<?php $date = JHTML::_('date', $this->item->created , 'd-F');
			$date = explode('-', $date);
			?>
			<div class="blogDate pull-left">
				<span class="sp_date_day"><?php echo $date[0]; ?></span>
				<span class="sp_month"><?php echo $date[1]; ?></span>
			</div>
 ...
 <div class="clr"></div>
  ...
  <div class="itemAuthorBlock">
    ...
    <div class="itemAuthorDetails">
      ...
      <span class="authorInfo"><?php echo $this->item->author->profile->description; ?></span>
      <?php endif; ?>
